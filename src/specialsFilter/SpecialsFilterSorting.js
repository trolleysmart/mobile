...
class SpecialsFilterSorting extends Component {
  ...
  render() {
    ...
    return (
      <View>
        <Menu>
          <MenuTrigger>
            <View style={Styles.selectedSortOption}>
              {renderSelectedSortOption()}
            </View>
          </MenuTrigger>
          <MenuOptions>
            <MenuOption
              onSelect={() => this.props.onSortOptionChanged('PriceAscending')}
            >
              {this.renderPriceLowToHigh()}
            </MenuOption>
            <MenuOption
              onSelect={() => this.props.onSortOptionChanged('PriceDescending')}
            >
              {this.renderPriceHighToLow()}
            </MenuOption>
            <MenuOption
              onSelect={() => this.props.onSortOptionChanged('SavingAscending')}
            >
              {this.renderSavingLowToHigh()}
            </MenuOption>
            <MenuOption
              onSelect={() =>
                this.props.onSortOptionChanged('SavingDescending')}
            >
              {this.renderSavingHighToLow()}
            </MenuOption>
            <MenuOption
              onSelect={() =>
                this.props.onSortOptionChanged('SavingPercentageAscending')}
            >
              {this.renderSavingPercentageLowToHigh()}
            </MenuOption>
            <MenuOption
              onSelect={() =>
                this.props.onSortOptionChanged('SavingPercentageDescending')}
            >
              {this.renderSavingPercentageHighToLow()}
            </MenuOption>
            <MenuOption
              onSelect={() => this.props.onSortOptionChanged('NameAscending')}
            >
              {this.renderNameAscending()}
            </MenuOption>
            <MenuOption
              onSelect={() => this.props.onSortOptionChanged('NameDescending')}
            >
              {this.renderNameDescending()}
            </MenuOption>
          </MenuOptions>
        </Menu>
      </View>
...
SpecialsFilterSorting.propTypes = {
  onSortOptionChanged: PropTypes.func.isRequired,
  sortOption: PropTypes.string.isRequired,
};

export default SpecialsFilterSorting;
