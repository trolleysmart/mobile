      ...
      <View>
        <List>
          <ListItem
            ...
            onPress={this.props.gotoDisclaimer}
          />
          <ListItem
            title="Sign out"
            leftIcon={{ name: 'ios-log-out-outline', type: 'ionicon' }}
        ...
        <View style={Styles.aboutContainer}>
          ...
          <Text>
            Copyright 2016 - {new Date().getFullYear()} Micro-business Ltd
          </Text>
          <Text
            onPress={this.props.handleClickPrivacyPolicyLink}
            style={Styles.hyperLink}
          >
            Privacy Policy
          </Text>
          <Text
            onPress={this.props.handleClickOpenSourceLicensesLink}
            style={Styles.hyperLink}
          >
            Open Source Licenses
          </Text>
          <Text
            onPress={this.props.handleClickTermsAndConditionLink}
            style={Styles.hyperLink}
          >
            Terms of Service
          </Text>
