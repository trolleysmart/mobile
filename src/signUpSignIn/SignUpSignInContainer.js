...
class UserSignInSignUpContainer extends Component {
  ...
  onSignInClicked = (emailAddress, password) => {
    this.props.userAccessActions.signInWithUsernameAndPassword(
      emailAddress,
      password,
    );
  };
  ...
  onSignUpClicked = (emailAddress, password) => {
    this.props.userAccessActions.signUpWithUsernameAndPassword(
      emailAddress,
      password,
      emailAddress,
    );
    ...
    return (
      <SignUpSignIn
        ...
        signUpOrSignInIsInProgress={
          this.props.signInStatus === Status.IN_PROGRESS ||
          this.props.signUpStatus === Status.IN_PROGRESS
        }
      />
    );
  };
